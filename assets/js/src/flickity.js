 ...
 * @param {number} index - which cell to start with
 */
 ...
 * @param {number} adjCount - number of adjacent slides
 * @param {number} index - index of slide to start
 ...
 * @param {number} increment - +1 or -1, going up or down
 ...
 * @param {number} index - Zero-based number to insert
 */
 ...
 * @param {number} changedCellIndex - index of the changed cell, optional

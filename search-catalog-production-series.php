				...
				<header class="grid-container archive pb-2 pb-medium-0">
					...
					<div class="grid-x align-center-middle">
						...
						<div class="cell small-6 text-right sorting">
							...
							<a data-toggle="searchProductionSeriesOffCanvas"> <?php _e('Sort & Filter', 'nacelle'); ?> </a>
				...
				<div class="grid-x small-2 medium-4 large-6 align-center-middle" id="results">
					...
					<?php else : ?>
						...
						<div class="cell text-center">
							...
							<a class="button" data-toggle="searchProductionSeriesOffCanvas"><?php _e('Try another search!', 'nacelle'); ?></a>

      ...
      <div class="grid-x social">
        <div class="cell text-center">
          ...
          <?php if ($socialchannel == 'facebook'): ?>
            ...
            <svg aria-hidden="true" data-prefix="fab" data-icon="facebook" class="svg-inline--fa fa-facebook fa-w-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" alt="facebook logo">
          ...
          <?php elseif ($socialchannel == 'twitter'): ?>
            ...
            <svg aria-hidden="true" data-prefix="fab" data-icon="twitter-square" class="svg-inline--fa fa-twitter-square fa-w-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" alt="twitter logo">
          ...
          <?php elseif ($socialchannel == 'instagram'): ?>
            ...
            <svg aria-hidden="true" data-prefix="fab" data-icon="instagram" class="svg-inline--fa fa-instagram fa-w-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" alt="instagram logo">
          ...
          <?php elseif ($socialchannel == 'youtube'): ?>
            ...
            <svg aria-hidden="true" data-prefix="fab" data-icon="youtube-square" class="svg-inline--fa fa-youtube-square fa-w-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" alt="youtube logo">
          ...
          <?php elseif ($socialchannel == 'soundcloud'): ?>
            ...
            <svg aria-hidden="true" data-prefix="fab" data-icon="soundcloud" class="svg-inline--fa fa-soundcloud fa-w-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" alt="soundcloud logo">
          ...
          <?php elseif ($socialchannel == 'spotify'): ?>
            ...
            <svg aria-hidden="true" data-prefix="fab" data-icon="spotify" class="svg-inline--fa fa-spotify fa-w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" alt="spotify logo">

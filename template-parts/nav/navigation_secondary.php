...
<nav id="<?php echo apply_filters( 'wp_rig_site_navigation_id', 'site-navigation_secondary' ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>" class="secondary-nav <?php echo apply_filters( 'wp_rig_site_navigation_classes', 'main-navigation' ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>" aria-label="<?php esc_attr_e( 'Main menu', 'wp-rig' ); ?>">

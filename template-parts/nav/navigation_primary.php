...
<nav id="<?php echo apply_filters( 'wp_rig_site_navigation_id', 'site-navigation_primary' ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>" class="primary-nav <?php echo apply_filters( 'wp_rig_site_navigation_classes', 'main-navigation main-navigation__primary nav--toggle-sub nav--toggle-small' ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>" aria-label="<?php esc_attr_e( 'Main menu', 'wp-rig' ); ?>">

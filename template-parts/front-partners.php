            ...
            <ul class="vertical tabs" data-tabs id="partners-tabs">
                    ...
                    <a class="partner-link" href="#panel2v">
                        <div class="partner">
                            <div class="region-top">
                                <h5 class="text-center">| <?php echo get_post_meta(get_the_ID(), 'right_icon', true); ?></h5>
                            </div>
                            <h3><?php echo get_post_meta(get_the_ID(), 'right_title', true); ?></h3>
                            <div class="region">
                                <h5 class="text-center">| <?php echo get_post_meta(get_the_ID(), 'right_icon', true); ?></h5>
                            </div>
                        </div>
                ...
                <li class="tabs-title one is-active" style="background-image: url('<?php bloginfo('template_directory'); ?>/dist/assets/images/Oval.svg'">
                    <a class="partner-link" href="#panel1v" aria-selected="true">
                        <div class="partner">
                            <div class="region-top">
                                <h5 class="text-center">| <?php echo get_post_meta(get_the_ID(), 'left_icon', true); ?></h5>
                            </div>
                            <h3><?php echo get_post_meta(get_the_ID(), 'left_title', true); ?></h3>
                            <div class="region">
                                <h5 class="text-center">| <?php echo get_post_meta(get_the_ID(), 'left_icon', true); ?></h5>
                            </div>
                        </div>

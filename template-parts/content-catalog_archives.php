...
<article class="productions">
  ...
  <div class="entry-content" id="entry-content">
    ...
    <div class="grid-x grid-padding-x small-up-2 macro-cat-cards">
            ...
            while($my_query->have_posts()) { $my_query->the_post();
                ...
                ?>
                    ...
                    <div class="cell">
                        ...
                        <!-- TITLE -->
                        <a href="<?php the_permalink() ?>" class="catalog-title" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><h3><?php the_title(); ?></h3></a>

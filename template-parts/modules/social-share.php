...
<div class="social-share<?php echo esc_html( $the_post_type ); ?>">
    ...
    if ( true === $hashes ) :
        ?>
        <span class="has-theme-secondary-color">###</span><br><?php endif; ?>Share</h3>
    <div class="social-share__icons">
        <a href="http://www.facebook.com/sharer.php?u=<?php echo wp_kses( $url, 'post' ); ?>" rel="noopener" target="_blank">
            <svg class="icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" aria-labelledby="facebookIcon">

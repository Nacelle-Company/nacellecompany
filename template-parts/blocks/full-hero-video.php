                ...
                <div class="grid-y grid-frame">
                    ...
                    <div id="videoHeroContainment-<?php echo $count; ?>" class="cell">
                        ...
                        <div id="big-video" class="big-video">
                            ...
                            ?>
                            <div id="fullHeroVideo-<?php echo $count; ?>" class="player grid-x align-bottom grid-padding-x grid-padding-y" onclick="jQuery('#fullHeroVideo-<?php echo $count; ?>').YTPUnmute()" data-property="{videoURL:'<?php echo $video; ?>', containment:'self', coverImage:'<?php echo $featured_img_url; ?>', mobileFallbackImage:'<?php echo $featured_img_url; ?>', autoPlay:true, mute:true, mask: '<?php echo $mask_url; ?>',showControls:false, optimize_display:true, loop:true, showYTLogo:false, stopMovieOnBlur:true,playOnlyIfVisible:true }">

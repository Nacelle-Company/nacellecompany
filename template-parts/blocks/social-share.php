...
/**
 * The template part for displaying social share links
 * Source: https://www.sitepoint.com/building-your-own-social-sharing-plugin-for-wordpress/
 * @package Nacelle
 * @since Nacelle 1.0.0
 */
...
$tw_icon = '
						<svg class="icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" aria-labelledby="iconTwitter">
								<title id="iconTwitter">Share on <?php echo get_bloginfo(); ?>Twitter</title>

                        ...
                        <div class="grid-x small-padding-collapse">
                            <div class="cell medium-12">
                                <?php if ($runtime) : ?>
                                    <div class="grid-x">
                                        <div class="cell small-4 title">
                                            <h4 class="sm-title"><?php _e('Runtime:', 'nacelle'); ?></h4>
                                        </div>
                                ...
                                <?php if ($show_date) : ?>
                                    ...
                                    <div class="grid-x">
                                        <div class="cell small-4 title">
                                            <h4 class="sm-title"><?php _e('Premiere:', 'nacelle'); ?></h4>
                                        </div>
                                        <div class="cell small-8">
                                ...
                                <?php if ($genres) : ?>
                                    <div class="grid-x">
                                        <div class="cell small-4 title">
                                            <h4 class="sm-title"><?php _e('Genre(s):', 'nacelle'); ?></h4>
                                        </div>
                                        <div class="cell small-8">
                                            <p>
                                                <?php $i = 1;
                                ...
                                <?php if (get_post_meta(get_the_ID(), 'rating', true)) : ?>
                                    <div class="grid-x">
                                        <div class="cell small-4 title">
                                            <h4 class="sm-title"><?php _e('Rating:', 'nacelle'); ?></h4>
                                        </div>
                                        <div class="cell small-8">
                                ...
                                <?php if (get_post_meta(get_the_ID(), 'copyright', true)) : ?>
                                    <div class="grid-x">
                                        <div class="cell small-4 title">
                                            <h4 class="sm-title"><?php _e('Copyright:', 'nacelle'); ?></h4>
                                        </div>
                                        <div class="cell small-8">

<div class=" link-lg-container grid-container-full pl-medium-3">

    <h2 class="sm-title white-color"><?php _e('Get your copy of', 'nacelle'); ?> <?php the_title(); ?></h2>

    <div class="grid-x grid-margin-x link-lg">

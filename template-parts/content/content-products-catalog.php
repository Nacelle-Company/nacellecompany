...
?>
<div class="cell">
    <header class="tabs tabs-products grid-x grid-padding-x grid-padding-y medium-up-2" data-responsive-accordion-tabs="tabs medium-accordion large-tabs" id="product-tabs">
        <div class="tabs-title is-active cell" aria-selected="true">
    ...
    <div class="tabs-content" data-tabs-content="product-tabs">
        <div class="tabs-panel is-active cell small-order-2 medium-order-1 medium-6 productions pt-3" id="panel1">
        ...
        <div class="tabs-panel cell small-order-1 medium-order-2 medium-6 podcasts pt-3" id="panel2">

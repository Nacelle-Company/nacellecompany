...
/**
 * The template for displaying MAIN comedy archive search results.
 *
                ...
                <header class="grid-container archive pb-2 pb-medium-0">
                    ...
                    <div class="grid-x align-center-middle pt-2 primary-title">
                        ...
                        <div class="cell small-6">
                            ...
                            <h1 class="entry-title"> <?php _e('Comedy', 'nacelle'); ?> </h1>

                        </div>

                        <div class="cell small-6 text-right sorting">

                            <a data-toggle="searchSpecialOffCanvas"> <?php _e('Sort & Filter', 'nacelle'); ?> </a>
                ...
                <div class="catalog-cards macro-cat-cards grid-x small-up-2 medium-up-4 large-up-6 align-top mt-medium-3" id="results">
                    ...
                    <?php else : ?>
                        ...
                        <div class="cell text-center">
                            ...
                            <a class="button" data-toggle="searchSpecialOffCanvas"><?php _e('Try another search!', 'nacelle'); ?></a>
...
<div class="off-canvas-wrapper">
    ...
    <div class="off-canvas position-right" id="searchSpecialOffCanvas" data-off-canvas>
        ...
        <div class="off-canvas-content" data-off-canvas-content>
            ...
            <div class="grid-x grid-margin-y align-center-middle oc-container pt-4 px-2">
                ...
                <div class="cell align-self-middle filter-sidebar">
                    ...
                    <h4 class="ml-2"><?php _e('Search Comedy', 'nacelle'); ?></h4>

...
<div class="orbit animation-element" data-timer-delay="2000" role="region" aria-label="Comedy Dynamics featured works" data-orbit data-options="animInFromLeft:fade-in; animInFromRight:fade-in; animOutToLeft:fade-out; animOutToRight:fade-out;">
  ...
  <ul class="orbit-container" height="auto">
    ...
    <?php $post_objects = get_field('home_feat_posts'); if ($post_objects): ?>
      ...
      <?php endforeach; ?> <!-- $post_objects as $post_object -->

    <?php endif; ?> <!-- $post_objects -->

<!-- for mobile -->
<?php if (wp_is_mobile()): ?>

    <?php $post_objects = get_field('home_circle_post'); if ($post_objects): ?>
      ...
      <?php endforeach; ?> <!-- END $post_objects as $post_object -->

    <?php endif; ?> <!-- END $post_objects -->

  <?php endif; ?> <!-- END wp_is_mobile if  -->
  </ul>

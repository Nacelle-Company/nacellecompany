				...
				<header class="grid-container archive">
					...
					<div class="grid-x align-center-middle">
						...
						<div class="cell small-6 text-right sorting">
							...
							<a data-toggle="searchProductionSeriesOffCanvas"> <?php _e('Sort & Filter', 'comedy-dynamics'); ?> </a>
                    ...
                    if (have_posts()) : ?>
						...
						<?php else : ?>
							...
							<div class="cell text-center">
								...
								<a class="button" data-toggle="searchProductionSeriesOffCanvas"><?php _e('Try another search!', 'comedy-dynamics'); ?></a>
...
<div class="off-canvas-wrapper">
	...
	<div class="off-canvas position-right" id="searchProductionSeriesOffCanvas" data-off-canvas>

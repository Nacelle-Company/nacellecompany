...
?>
        ...
        .secondary-bkgnd,.accordion-line,.button.success:not(.clear),.wp-block-button .success.wp-block-button__link,.off-canvas-content .searchandfilter input[type=submit],.field-wrap input[type=button],.button:hover,.flickity-page-dots .dot.is-selected {
        ...
        body,p,.instagram-title h3,blockquote,blockquote p,.carousel-full--news h3,.carousel-full--news p,.carousel-full--press h3,.carousel-full--press p {
        color: var(--txt-color);
        }

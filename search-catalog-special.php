				...
				<header class="grid-container archive">
					...
					<div class="grid-x align-center-middle">
						...
						<div class="cell small-6 text-right sorting">
							...
							<a data-toggle="searchSpecialOffCanvas">Sort & Filter</a>
                    ...
                    if (have_posts($args)) : ?>
						...
						<?php else : ?>
							<div class="cell text-center">
								...
								<a class="button" data-toggle="searchSpecialOffCanvas">Try another search!</a>
								<input type="submit" class="button search-filter-reset" name="_sf_reset" value="Or Reset" data-search-form-id="4741" data-sf-submit-form="auto">
							</div>
					<?php endif; ?>
			...
			<div class="grid-x grid-margin-y align-center-middle" style="height: 90vh;">
				<div class="cell align-self-middle filter-sidebar">
					...
					<?php
                        ...
                        echo do_shortcode('[searchandfilter id="4741"]'); // film
                    ?>

		...
		<div class="grid-x">
			...
			if ($post_objects): ?>
				...
				<?php foreach ($post_objects as $post_object) : ?>
					...
					<?php if ($rangeNumber < $numberRepeat) { break; } ?>
		...
		<div class="cell z-5">
			...
			<div class="grid-x grid-padding-x align-center home-content">
				...
				<div class="cell medium-8 scroll-arrow" data-smooth-scroll>
					...
					<a href="#more">
						<svg width="82" height="32" xmlns="http://www.w3.org/2000/svg"><g stroke="#FFF" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="bevel"><path d="M1.167 1.79l39.666 28.42M80.833 1.79L41.167 30.21"/></g></svg>
					</a>

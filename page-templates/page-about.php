		...
		<article id="post-<?php the_ID(); ?>" <?php post_class('grid-container'); ?>>
			...
			<div class="entry-content">
				<div class="grid-x align-center">
					<div class="cell medium-8 slideInFromBottom">
						<?php the_content(); ?>
					</div>
				</div>
				...
				<div class="grid-x grid-padding-x">
					<div class="cell medium-6 extra-content">
						<?php if (get_post_meta(get_the_ID(), 'left_content', true)) {
							echo get_post_meta(get_the_ID(), 'left_content', true);;
						} ?>
					</div>
					<div class="cell medium-6 extra-content">
						<?php if (get_post_meta(get_the_ID(), 'right_content', true)) {
							echo get_post_meta(get_the_ID(), 'right_content', true);;
						} ?>
					</div>
				</div>
			</div>

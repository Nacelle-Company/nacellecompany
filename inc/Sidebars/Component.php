...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function filter_body_classes( array $classes ) : array {
		if ( $this->is_primary_sidebar_active() ) {
			...
			if ( ! in_array( basename( $template ), array( 'page.php', 'page-home-cd.php', 'category.php', 'archive-catalog.php', 'single-catalog.php', '404.php', '500.php', 'offline.php', 'page-products.php', 'page-about.php', 'page-team.php', 'page-wonder.php', 'taxonomy.php', 'search.php' ) ) ) {
				$classes[] = 'has-sidebar';
			}
		}
		return $classes;

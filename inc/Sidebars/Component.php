...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function filter_body_classes( array $classes ) : array {
		if ( $this->is_primary_sidebar_active() ) {
			...
			if ( ! in_array( basename( $template ), array( 'page.php', 'front-page.php', 'category.php', 'archive-catalog.php', 'single-catalog.php', '404.php', '500.php', 'offline.php', 'page-about.php', 'page-wonder.php', 'taxonomy.php', 'search.php' ) ) ) {
				$classes[] = 'has-sidebar';
			}
		}
		return $classes;

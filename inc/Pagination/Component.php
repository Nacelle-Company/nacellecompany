...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function display_pagination() {
		 ...
		 * Catalog pagination
		 */
		$next_arrow = file_get_contents(get_template_directory().'/assets/images/src/icon-arrow-right.svg');
		$prev_arrow = file_get_contents(get_template_directory().'/assets/images/src/icon-arrow-left.svg');
